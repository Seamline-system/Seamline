...
function renderHistory() {
  ...
  if (quotes.length === 0) {
    container.innerHTML = `<div class="empty-state"><div class="icon">🗂</div><h3>No quotes yet</h3><p>Create your first quotation to see it here.</p></div>`;
    return;
  }
    ...
    <div class="quote-card">
      <div class="quote-card-header">
        <div>
          ...
          <div class="quote-date">${q.client} · ${q.contact||'No contact'} · ${formatDate(q.date)}
